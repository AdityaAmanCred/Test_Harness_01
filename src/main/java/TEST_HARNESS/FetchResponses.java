...
//            } else {
//                System.out.println("On " + envName + " ResponseCode: " + response.code() + " for " + pdfFileName.split("\\.")[0]);
//            }
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
//        Request request = new Request.Builder().url("http://optimus." + this.envName + ".dreamplug.net/pdf_to_json/file_stream/test/" + suffix)
